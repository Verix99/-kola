...
score = 0 
cisla = []
for line in batoh.split("\n"):
    delka =len(line)
    cast_1 = slice(0,len(line)//2)
    cast_2 = slice(len(line)//2,len(line))
    batoh_1 = line[cast_1]
    batoh_2 = line[cast_2]
    pismeno=(set(batoh_1)&set(batoh_2))     ####set() vypíše jednotlivá písmena/čísla, která se objeví v poli
